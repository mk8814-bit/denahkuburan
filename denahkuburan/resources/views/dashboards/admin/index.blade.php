...
<div class="card-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem">
    <div class="card" style="border-bottom: 4px solid var(--info)">
        <div style="display: flex; justify-content: space-between; align-items: center">
            <div>
                <p style="color: var(--gray-600); font-size: 0.875rem">Data Makam</p>
                <h2 style="font-size: 2rem; margin-top: 0.5rem">{{ $total_graves }}</h2>
            </div>
            <i data-lucide="database" style="width: 40px; height: 40px; color: var(--info); opacity: 0.2"></i>
        </div>
    </div>
    ...
    <div class="card" style="border-bottom: 4px solid var(--warning)">
        <div style="display: flex; justify-content: space-between; align-items: center">
            <div>
                <p style="color: var(--gray-600); font-size: 0.875rem">Pembayaran Pending</p>
                <h2 style="font-size: 2rem; margin-top: 0.5rem">{{ $pending_payments }}</h2>
            </div>
            <i data-lucide="clock" style="width: 40px; height: 40px; color: var(--warning); opacity: 0.2"></i>
        </div>
    </div>
</div>
    ...
    <div class="card mb-4" style="margin-bottom: 2rem;">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
            <h3 class="card-title mb-0" style="margin: 0;">Cek Denah Makam Keseluruhan</h3>
        ...
        <div class="card-body">
            ...
            <div class="map-container">
                @php
                    // Fetch all graves so the grid dimensions/positions remain constant
                        ...
                        <div class="blocks-container">
                            @foreach($blockRow as $blockIdx => $gravesInBlock)
                                @php
                                    ...
                                    $blockName = $gravesInBlock->first() ? $gravesInBlock->first()->block_name : 'Blok Baru';
                                @endphp
